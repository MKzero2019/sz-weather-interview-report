...
1. **资料搜寻能力** - 调研并选择合适的数据源，扩展数据指标
2. **程式码撰写能力** - 模块化、工程化的代码结构，面向对象编程
3. **数据处理能力** - 缺失值处理、异常值检测、特征工程等完整预处理流程
4. **图表分析能力** - 多维度可视化与统计分析，CPK过程能力分析
...
1. **数据真实可靠** - 使用Open-Meteo权威API获取真实数据，绝非模拟
2. **工程化程度高** - 模块化、可配置、可扩展的代码结构
3. **分析深度足够** - 从描述统计到过程能力分析，层层递进
4. **业务结合紧密** - 结合深圳春夏季节特点进行解读
5. **文档规范完整** - 从README到详细报告，文档体系完整
